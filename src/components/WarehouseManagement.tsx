        ...
        <div className="flex-1 flex flex-col h-screen overflow-hidden relative">
            ...
            <header className="bg-surface h-auto md:h-16 border-b border-gray-200 flex flex-wrap items-center justify-between px-6 py-3 md:py-0 shrink-0 z-10">
                ...
                <div className="flex items-center gap-3 w-full md:w-auto">
                    <div className="relative flex-grow">
                        <input
                            className="pl-9 pr-4 py-1.5 text-sm bg-background-light border border-gray-200 rounded-md focus:ring-1 focus:ring-primary focus:border-primary w-full transition-all"
            ...
            <div className="bg-surface border-b border-gray-200 p-4 shadow-sm shrink-0 z-10">
                <div className="flex items-center justify-between mb-2">
                    ...
                    <div className="text-xs text-text-muted font-mono hidden md:block">Presiona [Enter] para guardar</div>
                </div>
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-3 items-end">
                    <div className="flex-1 min-w-[200px] lg:col-span-2">
                    ...
                    <div className="grid grid-cols-3 gap-1 items-end">
                        <div className="w-full">
                            <label className="block text-[10px] font-bold text-text-muted mb-1 uppercase">Dim L"</label>
                        ...
                        <div className="w-full">
                            <label className="block text-[10px] font-bold text-text-muted mb-1 uppercase">W"</label>
                        ...
                        <div className="w-full">
                            <label className="block text-[10px] font-bold text-text-muted mb-1 uppercase">H"</label>
                    ...
                    <div className="md:col-span-2 lg:col-span-4">
                        <button className="bg-primary hover:bg-primary-light text-white px-6 py-2 rounded shadow-sm font-bold text-sm flex items-center gap-2 h-[38px] transition-colors w-full md:w-auto md:ml-auto">
            ...
            <div className="flex-1 overflow-auto bg-white border-t border-gray-200">
                <table className="w-full text-left border-collapse">
                        <thead className="bg-gray-50 sticky top-0 z-0 shadow-sm">
                            <tr>
                                <th className="px-2 md:px-4 py-3 border-b border-gray-200 w-10">
                                    <input className="rounded border-gray-300 text-primary focus:ring-primary w-4 h-4" type="checkbox" />
                                </th>
                                <th className="px-2 md:px-4 py-3 border-b border-gray-200 text-xs font-bold text-text-muted uppercase tracking-wider">ID Manifiesto</th>
                                <th className="px-2 md:px-4 py-3 border-b border-gray-200 text-xs font-bold text-text-muted uppercase tracking-wider hidden md:table-cell">Equipo / Contenido</th>
                                <th className="px-2 md:px-4 py-3 border-b border-gray-200 text-xs font-bold text-text-muted uppercase tracking-wider hidden lg:table-cell">Cliente</th>
                                <th className="px-2 md:px-4 py-3 border-b border-gray-200 text-xs font-bold text-text-muted uppercase tracking-wider hidden lg:table-cell">Recepción</th>
                                <th className="px-2 md:px-4 py-3 border-b border-gray-200 text-xs font-bold text-text-muted uppercase tracking-wider text-right hidden md:table-cell">Peso (KG)</th>
                                <th className="px-2 md:px-4 py-3 border-b border-gray-200 text-xs font-bold text-text-muted uppercase tracking-wider text-right hidden lg:table-cell">Vol (M³)</th>
                                <th className="px-2 md:px-4 py-3 border-b border-gray-200 text-xs font-bold text-text-muted uppercase tracking-wider text-center">Estado</th>
                                <th className="px-2 md:px-4 py-3 border-b border-gray-200 text-xs font-bold text-text-muted uppercase tracking-wider text-right">Acciones</th>
                            </tr>
                        </thead>
                        <tbody className="divide-y divide-gray-100">
                            {filteredPackages.map((pkg) => (
                                <tr key={pkg.id} className="group hover:bg-blue-50/50 transition-colors h-10">
                                    <td className="px-2 md:px-4 py-2 w-10">
                                        <input
                                    ...
                                    <td className="px-2 md:px-4 py-2 text-sm text-text-main font-bold hidden md:table-cell">{pkg.equipment}</td>
                                    <td className="px-2 md:px-4 py-2 text-sm text-text-main hidden lg:table-cell">
                                        <span className="font-mono text-xs text-text-muted mr-1">{pkg.clientId}</span> {pkg.client}
                                    </td>
                                    <td className="px-2 md:px-4 py-2 font-mono text-xs text-text-muted hidden lg:table-cell">{pkg.date}</td>
                                    <td className="px-2 md:px-4 py-2 font-mono text-sm text-text-main text-right hidden md:table-cell">{pkg.weight.toLocaleString()}</td>
                                    <td className="px-2 md:px-4 py-2 font-mono text-sm text-text-muted text-right hidden lg:table-cell">{pkg.volume.toFixed(1)}</td>
